...
public class IpManagement {
     ...
     *@param netmask
     */
    public IpManagement(String symbolicIP, String netmask) throws NumberFormatException {
...
*/
     ...
     */
    public IpManagement(String IPinCIDRFormat) throws NumberFormatException {
    ...
    public boolean contains(IpManagement child) {
