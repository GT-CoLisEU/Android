...
#include "../iperf-2.0.5/reset_globals.h"
        ...
        )
{
    ...
    a = BWLToolGenericFillCPUAffinityCommand(ctx, tsess->tool, IperfArgs);
        ...
        )
{
    ...
    __android_log_print(ANDROID_LOG_DEBUG, "LOG_JNI", "bwctl: Now run iperf!");
    int nargs = 0;
    while(ipargs[nargs]){
        __android_log_print(ANDROID_LOG_DEBUG, "LOG_JNI", "bwctl: %s", ipargs[nargs]);
        nargs++;
    }
    /*
    __android_log_print(ANDROID_LOG_DEBUG, "LOG_JNI", "bwctl: %s", ipargs[0]);
    __android_log_print(ANDROID_LOG_DEBUG, "LOG_JNI", "bwctl: %s", ipargs[1]);
    __android_log_print(ANDROID_LOG_DEBUG, "LOG_JNI", "bwctl: %s", ipargs[2]);
    __android_log_print(ANDROID_LOG_DEBUG, "LOG_JNI", "bwctl: %s", ipargs[3]);
    __android_log_print(ANDROID_LOG_DEBUG, "LOG_JNI", "bwctl: %s", ipargs[4]);
    __android_log_print(ANDROID_LOG_DEBUG, "LOG_JNI", "bwctl: %s", ipargs[5]);
    __android_log_print(ANDROID_LOG_DEBUG, "LOG_JNI", "bwctl: %s", ipargs[6]);
    __android_log_print(ANDROID_LOG_DEBUG, "LOG_JNI", "bwctl: %s", ipargs[7]);
    __android_log_print(ANDROID_LOG_DEBUG, "LOG_JNI", "bwctl: %s", ipargs[8]);
    __android_log_print(ANDROID_LOG_DEBUG, "LOG_JNI", "bwctl: %s", ipargs[9]);
    __android_log_print(ANDROID_LOG_DEBUG, "LOG_JNI", "bwctl: %s", ipargs[10]);
    __android_log_print(ANDROID_LOG_DEBUG, "LOG_JNI", "bwctl: %s", ipargs[11]);
    __android_log_print(ANDROID_LOG_DEBUG, "LOG_JNI", "bwctl: %s", ipargs[12]);
    __android_log_print(ANDROID_LOG_DEBUG, "LOG_JNI", "bwctl: %s", ipargs[13]);
    __android_log_print(ANDROID_LOG_DEBUG, "LOG_JNI", "bwctl: %s", ipargs[14]);
    __android_log_print(ANDROID_LOG_DEBUG, "LOG_JNI", "bwctl: %s", ipargs[15]);*/

    /*
     * Now run iperf!
     */

     iperf_wrapper(nargs,ipargs);
