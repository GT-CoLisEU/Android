...
print_usage(void)
{
	__android_log_print(ANDROID_LOG_DEBUG, "JNI_ERROR_LOG", "Usage: \n");
	__android_log_print(ANDROID_LOG_DEBUG, "JNI_ERROR_LOG", " thrulay [-h] [-V] [-v] [-b] [-D DSCP] [-m#] [-t#] "
			"[-i#] [-w#] [-l#] [-p#] [-u#] [-T#] [-g group] "
			"host\n");
	...
	__android_log_print(ANDROID_LOG_DEBUG, "JNI_ERROR_LOG", "\t-b\t\tBusy wait in UDP test\n");
	__android_log_print(ANDROID_LOG_DEBUG, "JNI_ERROR_LOG", "\t-D DSCP\t\tDSCP value for TOS byte "
			"(default: unset)\n");
	__android_log_print(ANDROID_LOG_DEBUG, "JNI_ERROR_LOG", "\t-m#\t\tnumber of test streams (default: 1)\n");
	__android_log_print(ANDROID_LOG_DEBUG, "JNI_ERROR_LOG", "\t-t#\t\ttest duration, in seconds (default: 60s)\n");
	__android_log_print(ANDROID_LOG_DEBUG, "JNI_ERROR_LOG", "\t-i#\t\treporting interval, in seconds "
			"(default: 1s)\n");
	__android_log_print(ANDROID_LOG_DEBUG, "JNI_ERROR_LOG", "\t\t\t0 disables intermediate reports\n");
	__android_log_print(ANDROID_LOG_DEBUG, "JNI_ERROR_LOG", "\t-w#\t\twindow, in bytes (default: 4194304B)\n");
	__android_log_print(ANDROID_LOG_DEBUG, "JNI_ERROR_LOG", "\t-l#\t\tblock size, in bytes (default: 64kB)\n");
	__android_log_print(ANDROID_LOG_DEBUG, "JNI_ERROR_LOG", "\t-p#\t\tserver port (default: 5003)\n");
	__android_log_print(ANDROID_LOG_DEBUG, "JNI_ERROR_LOG", "\t-u#[kMGT]\tUDP mode with given rate "
				"(default: off)\n"
	...
	__android_log_print(ANDROID_LOG_DEBUG, "JNI_ERROR_LOG", "\t-T#\t\tTTL field for multicast (default: 1)\n");
	__android_log_print(ANDROID_LOG_DEBUG, "JNI_ERROR_LOG", "\t-g group\tmulticast group to send data to\n");
	__android_log_print(ANDROID_LOG_DEBUG, "JNI_ERROR_LOG", "\thost\t\tserver to connect to (no default)\n");
}
...
//		case 'D':
//			if (thrulay_opt.dscp) {
//				__android_log_print(ANDROID_LOG_DEBUG, "JNI_ERROR_LOG", "can only set \'-D\' once.\n");
//				usage();
//			}
...
//				__android_log_print(ANDROID_LOG_DEBUG, "JNI_ERROR_LOG", "invalid value for option "
...
//				__android_log_print(ANDROID_LOG_DEBUG, "JNI_ERROR_LOG", "number of test streams must "
...
//				__android_log_print(ANDROID_LOG_DEBUG, "JNI_ERROR_LOG", "test duration must be "
...
//				__android_log_print(ANDROID_LOG_DEBUG, "JNI_ERROR_LOG", "reporting interval must be 0 "
...
//				__android_log_print(ANDROID_LOG_DEBUG, "JNI_ERROR_LOG", "block size must be "
//					"a positive integer (in bytes)\n");
//				usage();
//			}
//			break;
...
//				__android_log_print(ANDROID_LOG_DEBUG, "JNI_ERROR_LOG", "rate must be positive\n");
//				usage();
//			}
//			break;
//		case 'T':
...
//				__android_log_print(ANDROID_LOG_DEBUG, "JNI_ERROR_LOG", "TTL cannot be negative\n");
//				usage();
//			}
//#else
...
//		__android_log_print(ANDROID_LOG_DEBUG, "JNI_ERROR_LOG", "No reporting interval with UDP tests.\n");
//		usage();
//	}
//#endif
//
...
//		__android_log_print(ANDROID_LOG_DEBUG, "JNI_ERROR_LOG", "A multicast group was specified for a TCP "
...
//	if (rc < 0) {
//		__android_log_print(ANDROID_LOG_DEBUG, "JNI_ERROR_LOG", "During test: ");
//		error(ERR_FATAL, thrulay_client_strerror(rc));
//	}
//
//	rc = thrulay_client_report_final();
//	if (rc < 0) {
//		__android_log_print(ANDROID_LOG_DEBUG, "JNI_ERROR_LOG", "While generating final report: ");
//		error(ERR_FATAL, thrulay_client_strerror(rc));
//	}
//
//	thrulay_client_exit();
